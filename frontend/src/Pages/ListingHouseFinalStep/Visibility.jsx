...
const Visibility = () => {
  ...
  return (
    <div className=" flex flex-col gap-10 max-w-screen-md mx-auto my-6 min-h-[70vh]">
      ...
      <PlaceTypeCard
        desc={
          "Get reservations faster when you welcome anyone from the Hostel community."
        }
        head={"Any Hostel guest"}
      ...
      />
      <PlaceTypeCard
        desc="For your first guest, welcome someone with a good track record on Hostel who can offer tips for how to be a great Host"
