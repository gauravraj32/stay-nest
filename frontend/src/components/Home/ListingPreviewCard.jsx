    ...
    <>
      ...
      <div className=" flex flex-row justify-between items-start w-full">
        ...
        <div className=" flex flex-col gap-1">
          ...
          {
            listingData?.location?.addressLineOne  && <p className="text-xs w-full">
              <span>{listingData?.location?.addressLineOne}</span>
              <span>{listingData?.location?.addressLineTwo}</span>
            </p>
