  ...
  return (
    <section className=" my-8 md:my-20 flex flex-col gap-10">
      <h1 className=" text-2xl md:text-4xl text-[#222222] font-medium text-center">
        Hostel it easily with Hostel Setup
      </h1>
      <>
      ...
      <div className=" grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <SetupCard
          ...
          subHeading={
            "For your first booking, you can choose to welcome an experienced guest who has at least three stays and a good track record on Hostel."
          }
        />
        <SetupCard
          heading={"Specialized support from Hostel"}
          subHeading={
